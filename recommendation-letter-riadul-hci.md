...
His portfolio shows a sustained interest in designing for real users and real constraints. In his Onnomatra case study, he worked on an e-commerce/no-code platform intended to help Bangladeshi sellers create websites, products, content, and orders from one place. His documented contributions included user research, 5W2H analysis, personas, user flows, information architecture, product strategy, mind mapping, wireframing, and UI design. His OmniPixCraft case study involved automating Open Graph image creation for WordPress websites, with contributions in user research, ideation, style-guide development, user flows, information architecture, and user-interface design.

Sakib’s undergraduate thesis, **“Guava Leaf Disease Detection and Classification Based on Transfer Learning Technique,”** further developed his understanding of intelligent systems in a real-world context. The thesis addressed early detection of guava diseases and considered practical concerns including interpretability, real-time prediction, responsible deployment, and usefulness to farmers. He compared Xception, Inception V3, VGG16, and VGG19 using a seven-class image dataset; Xception achieved 95.54% test accuracy. This experience gives him a meaningful foundation for studying how AI systems can become understandable, usable, and trustworthy.
