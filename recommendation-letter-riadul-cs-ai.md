# Recommendation Letter — Computer Science / Software Engineering / AI
...
Sakib compared four transfer-learning architectures—Xception, Inception V3, VGG16, and VGG19. He used Python with TensorFlow, Keras, and OpenCV in Jupyter Notebook and Google Colab. The training setup used the Adam optimizer, a batch size of 32, and 150 epochs. Xception achieved the strongest result, with 99.12% training accuracy, 95.86% validation accuracy, and 95.54% test accuracy. He also examined precision, recall, F1-score, loss, and confusion matrices rather than relying on a single metric.

An additional strength of the work was Sakib’s awareness of its limitations. He recognized that constrained data, visually similar diseases, and variation across locations and conditions could affect generalization. This ability to connect implementation with evaluation and limitations is important for advanced AI research and responsible software development.
